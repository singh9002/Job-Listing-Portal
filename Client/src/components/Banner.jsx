...
const Banner = ({query,handleInputChange}) => {
  ...
  return (
    ...
    <h1 className='text-5xl font-bold text-primary mb-3'>Uplift your
    <span className='text-pink'> new career</span> today</h1>
    <p className='text-pink text-black/70 mb-8'>Thosands of jobs in the computer, engineering and technology sectors are waiting for you.</p>
    ...
    <form>
        <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
            <div className='flex md:rounded-s-md rounded shadow-sm ring-1 ring-insert ring-gray-300 focus-within:ring-2 focus:within:ring-inset focus:within:ring-indigo-600 md:w-1/2 w-full'>
                ...
                placeholder='What role defines you?'
        ...
        <button type="submit" className='bg-pink py-2 px-8 text-white md:rounded-s-none rounded'>Search</button>
        </div>
    </form>
    </div>
  )
